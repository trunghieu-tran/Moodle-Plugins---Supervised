...
/**
 * The supervised hide classroom event.
 *
 * @package     block
...
/**
 * The hide_classroom event class.
 * @since     Moodle 2.7
 * @copyright 2014 Oleg Sychev, Volgograd State Technical University
 * @license   http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 **/
class hide_classroom extends  update_object {

    public static function get_name() {
        return get_string('eventhideclassroom', 'block_supervised');
    }

    public function get_description() {
        return "The user with id '$this->userid' hid classroom with id '{$this->other['classroomid']}'.";
    }
    ...
    public function get_legacy_logdata() {
        return array($this->other['courseid'], 'role', 'hide classroom',
