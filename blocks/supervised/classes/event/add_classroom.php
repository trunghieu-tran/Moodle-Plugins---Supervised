...
class add_classroom extends  add_object {
    ...
    public function get_url() {
        return new \moodle_url('/blocks/supervised/classrooms/addedit.php', array('id' => $this->other['newclassid'], 'courseid' => $this->other['courseid']));
    }
 
    public function get_legacy_logdata() {
        return array($this->other['courseid'], 'role', 'add classroom',
		"blocks/supervised/classrooms/addedit.php?id={$this->other['newclassid']}&courseid={$this->other['courseid']}", $this->other['fromform_name']);
    }
}