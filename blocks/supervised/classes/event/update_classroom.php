...
class update_classroom extends  update_object {
    ...
    public function get_url() {
        return new \moodle_url('/blocks/supervised/classrooms/addedit.php', array('id' => $this->other['fromform_id'],
                                'courseid' => $this->other['courseid']));
    }

    public function get_legacy_logdata() {
        return array($this->other['courseid'], 'role', 'edit classroom',
            "blocks/supervised/classrooms/addedit.php?id={$this->other['fromform_id']}&courseid={$this->other['courseid']}",
