...
class block_formal_langs_token_base_test extends UnitTestCase {
    function test_damerau_levenshtein_tb() {
        ...
        $this->assertTrue(block_formal_langs_token_base::damerau_levenshtein('aaaaa', 'ààààà')==5);//different languages
        ...
        $this->assertTrue(block_formal_langs_token_base::damerau_levenshtein('helllo', 'hlello')==1);//1 transposition
    }
}
?>
