...
$string['formal_langs:edit_all_languages'] = 'Может редактировать все формальные языки (кроме системных)';
$string['formal_langs:edit_own_languages'] = 'Может редактировать только те, формальные языки, что создал сам';
