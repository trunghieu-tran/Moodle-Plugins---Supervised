...
$string['formal_langs:edit_all_languages'] = 'Can edit all registered formal languages (except for system)';
$string['formal_langs:edit_own_languages'] = 'Can edit only own created formal languages';
