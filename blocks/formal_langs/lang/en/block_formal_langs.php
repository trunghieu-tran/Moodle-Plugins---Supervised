...
$string['lang_c_language_help'] = 'C programmging languge. Scanning only.';
$string['lang_c++_language'] = 'C++ programming language';
$string['lang_c++_language_help'] = 'C++ programmging languge. Scanning only.';
