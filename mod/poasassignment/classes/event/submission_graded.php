...
/**
 * mod_poasassignment submission graded event.
 *
...
/**
 * mod_poasassignment submission graded event class.
 *
 * @package    mod_poasassignment
...
class submission_graded extends \core\event\base {
    ...
    public static function get_name() {
        return get_string('event_submission_graded', 'mod_poasassignment');
    }
