...
* Edit all the files in this directory and its subdirectories and change
  all the instances of the string "poasassignment" to your module name
  (eg "widget"). If you are using Linux, you can use the following command
  $ find . -type f -exec sed -i 's/poasassignment/widget/g' {} \;

* Rename the file lang/en_utf8/poasassignment.php to lang/en_utf8/widget.php
...
* Go to Site Administration > Plugins > Activity modules > Manage activities
  and you should find that this poasassignment has been added to the list of
  installed modules.
