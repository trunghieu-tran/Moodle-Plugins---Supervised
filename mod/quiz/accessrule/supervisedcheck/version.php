...
$plugin->version   = 2015101700;                    // The current module version (Date: YYYYMMDDXX)
$plugin->requires  = 2015051100;                    // Requires this Moodle version
$plugin->component = 'quizaccess_supervisedcheck';  // Full name of the plugin (used for diagnostics).
$plugin->dependencies = array('block_supervised' => 2015101700);
$plugin->release    = 'Supervised check quiz access rule 2.9';
