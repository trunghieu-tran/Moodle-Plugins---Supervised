...
$string['enumanalyzerrequiresequence'] = 'Анализ перечислений требует, чтобы анализ последовательности лексем был включен';
...
$string['howtofixpichintpenalty_help'] = 'Подсказка "как можно исправить", в виде изображения, показывает студенту сообщение о том, между какие операции надо применить над лексемой для исправления ошибки в лексеме. Если возможно, используются описания лексем, если нет - текстовые значения. Вы можете отключить подсказку установив штраф более 1.';
...
$string['syntaxanalyzerrequiresequence'] = 'Анализ покрытия синтаксического дерева требует, чтобы анализ последовательности лексем был включен';
