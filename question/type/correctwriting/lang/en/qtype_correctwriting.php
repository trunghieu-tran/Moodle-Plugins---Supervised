...
$string['enumanalyzerrequiresequence'] = 'Enumeration analysis requires token sequence analysis to be enabled';
...
$string['howtofixpichintpenalty_help'] = '"How to fix" picture hint shows student a picture about operations, that should be used for fixing operations. Token descriptions are used when possible, token value otherwise. Setting penalty above 1 will disable the hint.';
...
$string['syntaxanalyzerrequiresequence'] = 'Tree coverage analysis requires token sequence analysis to be enabled';
