...
$string['whatishintpenalty_help'] = '"What is" hint allows student to see token value instead of description in mistake message in adaptive behaviour. Setting penalty above 1 will disable "what is" hint.';
