...
$string['and'] = ' and ';
$string['answersinstruct'] = 'Enter one or more correct answers. When you try to save the questions, answers will be tokenized using rules of selected language and you will be given an option to enter descriptions for each token. Token description is used instead of token text in mistake messages and hints to not disclose to the student actual value of the token. If you leave description empty, token value will be used instead.';
