...
if ($ADMIN->fulltree) {
    ...
    $settings->add(new admin_setting_configtext('qtype_preg_fa_recursion_limit', get_string('fa_recursion_limit', 'qtype_preg'),
                    get_string('fa_recursion_limit_description', 'qtype_preg'), 1000, PARAM_INT));
