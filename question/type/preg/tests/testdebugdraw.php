...
class qtype_preg_draw_test extends PHPUnit_Framework_TestCase {
    ...
    function test_dot_style_provider() {
        ...
        $etalon_dot_instructions1 = 'digraph ' . qtype_preg_dot_style_provider::get_graph_name() . ' {rankdir = LR;3[label = "( ... )", tooltip = subexpression, id = 3];2[label = "|", tooltip = alternative, id = 2];0[label = "a", tooltip = "character class", shape = rectangle, id = 0];1[label = "emptiness", tooltip = emptiness, shape = rectangle, id = 1];3->2->0;2->1;}';
