...
class qtype_preg_draw_test extends PHPUnit_Framework_TestCase {
    ...
    function test_dot_style_provider() {
        ...
        */
        $styleprovider = new qtype_preg_dot_style_provider();
        $this->assertTrue($etalon_dot_instructions1 === $root1->dot_script($styleprovider),'Test with regex (a|) failed!');
        $this->assertTrue($etalon_dot_instructions2 === $root2->dot_script($styleprovider),'Test with regex ^\\\\a\\b\\A\\Z\\G$ failed!');
        $this->assertTrue($etalon_dot_instructions3 === $root3->dot_script($styleprovider),'Test with regex abc[\\w\\W\\s\\S\\d\\D\\h\\H\\v\\V] failed!');
        $this->assertTrue($etalon_dot_instructions4 === $root4->dot_script($styleprovider),'Test with regex abc[\\w\\W\\s] failed!');
        $this->assertTrue($etalon_dot_instructions5 === $root5->dot_script($styleprovider),'Test with regex abc[\\S\\d\\D] failed!');
        $this->assertTrue($etalon_dot_instructions6 === $root6->dot_script($styleprovider),'Test with regex 345[\\h\\H\\v\\V] failed!');
        $this->assertTrue($etalon_dot_instructions7 === $root7->dot_script($styleprovider),'Test with regex abc[^\\w\\W\\s\\S\\d\\D\\h\\H\\v\\V] failed!');
        $this->assertTrue($etalon_dot_instructions8 === $root8->dot_script($styleprovider),'Test with regex abc[^\\w\\W\\s] failed!');
        $this->assertTrue($etalon_dot_instructions9 === $root9->dot_script($styleprovider),'Test with regex abc[^\\S\\d\\D] failed!');
        $this->assertTrue($etalon_dot_instructions10 === $root10->dot_script($styleprovider),'Test with regex 345[^\\h\\H\\v\\V] failed!');
        $this->assertTrue($etalon_dot_instructions11 === $root11->dot_script($styleprovider),'Test with regex abc\\w\\W\\s\\S\\d\\D\\h\\H\\v\\V failed!');
        $this->assertTrue($etalon_dot_instructions12 === $root12->dot_script($styleprovider),'Test with regex abc\\w\\W\\s failed!');
        $this->assertTrue($etalon_dot_instructions13 === $root13->dot_script($styleprovider),'Test with regex abc\\S\\d\\D failed!');
        $this->assertTrue($etalon_dot_instructions14 === $root14->dot_script($styleprovider),'Test with regex 345\\h\\H\\v\\V failed!');
        $this->assertTrue($etalon_dot_instructions15 === $root15->dot_script($styleprovider),'Test with regex [a-z2-5]33* failed!');
        $this->assertTrue($etalon_dot_instructions16 === $root16->dot_script($styleprovider),'Test with regex [B-D!.].{1,5}23? failed!');
        $this->assertTrue($etalon_dot_instructions17 === $root17->dot_script($styleprovider),'Test with regex \\A[^c-z;-](ef)+ failed!');
        $this->assertTrue($etalon_dot_instructions18 === $root18->dot_script($styleprovider),'Test with regex abc{3,7} failed!');
        $this->assertTrue($etalon_dot_instructions19 === $root19->dot_script($styleprovider),'Test with regex abc{3,} failed!');
        $this->assertTrue($etalon_dot_instructions20 === $root20->dot_script($styleprovider),'Test with regex abc{,7} failed!');
        $this->assertTrue($etalon_dot_instructions21 === $root21->dot_script($styleprovider),'Test with regex abc{0,7} failed!');
        $this->assertTrue($etalon_dot_instructions22 === $root22->dot_script($styleprovider),'Test with regex [^a-z]*? failed!');
        $this->assertTrue($etalon_dot_instructions23 === $root23->dot_script($styleprovider),'Test with regex [^A-Z]+? failed!');
        $this->assertTrue($etalon_dot_instructions24 === $root24->dot_script($styleprovider),'Test with regex [^3-9]{5,}? failed!');
        $this->assertTrue($etalon_dot_instructions25 === $root25->dot_script($styleprovider),'Test with regex [^\W33]*+ failed!');
        $this->assertTrue($etalon_dot_instructions26 === $root26->dot_script($styleprovider),'Test with regex [^\D\S]?+ failed!');
        $this->assertTrue($etalon_dot_instructions27 === $root27->dot_script($styleprovider),'Test with regex [^\w\d]{5,}+ failed!');
        $this->assertTrue($etalon_dot_instructions28 === $root28->dot_script($styleprovider),'Test with regex ab(xa)*+a failed!');
        $this->assertTrue($etalon_dot_instructions29 === $root29->dot_script($styleprovider),'Test with regex a(bc|b|x)cc failed!');
        $this->assertTrue($etalon_dot_instructions30 === $root30->dot_script($styleprovider),'Test with regex a(?:bc|b|x)cc failed!');
        $this->assertTrue($etalon_dot_instructions31 === $root31->dot_script($styleprovider),'Test with regex a(?>bc|b|x)cc failed!');
        $this->assertTrue($etalon_dot_instructions32 === $root32->dot_script($styleprovider),'Test with regex a(?>x*)xa failed!');
        $this->assertTrue($etalon_dot_instructions33 === $root33->dot_script($styleprovider),'Test with regex (?-i)(?i:tv)set failed!');
        $this->assertTrue($etalon_dot_instructions34 === $root34->dot_script($styleprovider),'Test with regex my name is (?=Freedom) failed!');
        $this->assertTrue($etalon_dot_instructions35 === $root35->dot_script($styleprovider),'Test with regex my name is (?!Freedom) failed!');
        $this->assertTrue($etalon_dot_instructions36 === $root36->dot_script($styleprovider),'Test with regex my name is (?<=Freedom) failed!');
        $this->assertTrue($etalon_dot_instructions37 === $root37->dot_script($styleprovider),'Test with regex my name is (?<!Freedom) failed!');
        $this->assertTrue($etalon_dot_instructions38 === $root38->dot_script($styleprovider),'Test with regex (?(?<=a)m|d) failed!');
        $this->assertTrue($etalon_dot_instructions39 === $root39->dot_script($styleprovider),'Test with regex (a)?(?(?1)m|d) failed!');
        $this->assertTrue($etalon_dot_instructions40 === $root40->dot_script($styleprovider),'Test with regex a\.? failed!');
        $this->assertTrue($etalon_dot_instructions41 === $root41->dot_script($styleprovider),'Test with regex a\\\\b failed!');
        $this->assertTrue($etalon_dot_instructions42 === $root42->dot_script($styleprovider),'Test with regex a\[F\] failed!');
        $this->assertTrue($etalon_dot_instructions43 === $root43->dot_script($styleprovider),'Test with regex \Q+-*/\E failed!');
        $this->assertTrue($etalon_dot_instructions44 === $root44->dot_script($styleprovider),'Test with regex (a+a+)+a failed!');
        $this->assertTrue($etalon_dot_instructions45 === $root45->dot_script($styleprovider),'Test with regex :::1:::0:|:::1:1:0: failed!');
        $this->assertTrue($etalon_dot_instructions46 === $root46->dot_script($styleprovider),'Test with regex :::1:::0:|:::1:1:1::: failed!');
        $this->assertTrue($etalon_dot_instructions47 === $root47->dot_script($styleprovider),'Test with regex [[:upper:]]A failed!');
        $this->assertTrue($etalon_dot_instructions48 === $root48->dot_script($styleprovider),'Test with regex [[:lower:]]+az failed!');
        $this->assertTrue($etalon_dot_instructions49 === $root49->dot_script($styleprovider),'Test with regex [[:alpha:]]*35 failed!');
        $this->assertTrue($etalon_dot_instructions50 === $root50->dot_script($styleprovider),'Test with regex [[:digit:]]?Z failed!');
        $this->assertTrue($etalon_dot_instructions51 === $root51->dot_script($styleprovider),'Test with regex [[:xdigit:]]|3AZ failed!');
        $this->assertTrue($etalon_dot_instructions52 === $root52->dot_script($styleprovider),'Test with regex [[:alnum:]]**a failed!');
        $this->assertTrue($etalon_dot_instructions53 === $root53->dot_script($styleprovider),'Test with regex [[:word:]][2-4!] failed!');
        $this->assertTrue($etalon_dot_instructions54 === $root54->dot_script($styleprovider),'Test with regex [[:punct:]][^3333] failed!');
        $this->assertTrue($etalon_dot_instructions55 === $root55->dot_script($styleprovider),'Test with regex [[:blank:]](a|b) failed!');
        $this->assertTrue($etalon_dot_instructions56 === $root56->dot_script($styleprovider),'Test with regex [[:space:]]{3,} failed!');
        $this->assertTrue($etalon_dot_instructions57 === $root57->dot_script($styleprovider),'Test with regex [[:cntrl:]]{,5} failed!');
        $this->assertTrue($etalon_dot_instructions58 === $root58->dot_script($styleprovider),'Test with regex [[:graph:]]{0,0} failed!');
        $this->assertTrue($etalon_dot_instructions59 === $root59->dot_script($styleprovider),'Test with regex [[:print:]]{2,7} failed!');
        $this->assertTrue($etalon_dot_instructions60 === $root60->dot_script($styleprovider),'Test with regex (ab|cd*$|){3,100} failed!');
        $this->assertTrue($etalon_dot_instructions61 === $root61->dot_script($styleprovider),'Test with regex [[-]] failed!');
        $this->assertTrue($etalon_dot_instructions62 === $root62->dot_script($styleprovider),'Test with regex [[.NIL.]] failed!');
        $this->assertTrue($etalon_dot_instructions63 === $root63->dot_script($styleprovider),'Test with regex [[=aleph=]](NULL)? failed!');
        $this->assertTrue($etalon_dot_instructions64 === $root64->dot_script($styleprovider),'Test with regex BE$33[\w!-] failed!');
        $this->assertTrue($etalon_dot_instructions65 === $root65->dot_script($styleprovider),'Test with regex abc^ failed!');
        $this->assertTrue($etalon_dot_instructions66 === $root66->dot_script($styleprovider),'Test with regex 11111111111111111111111111111111111111111111111111111 failed!');
    }
