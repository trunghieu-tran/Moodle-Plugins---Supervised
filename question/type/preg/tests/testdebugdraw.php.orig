...
require_once('/var/www/moodle/question/type/preg/nfa_matcher/nfa_matcher.php');
require_once('/var/www/moodle/question/type/preg/dfa_matcher/dfa_matcher.php');
require_once('/var/www/moodle/question/type/preg/preg_dotstyleprovider.php');
...
class qtype_preg_draw_test extends PHPUnit_Framework_TestCase {
    ...
    function test_draw_ast() {
        ...
        $etalon_dot_instructions56 = 'digraph {rankdir = LR;1[label = "{3,}", tooltip = "infinite quantifier", id = 1];0[label = "[[:space:]]", tooltip = "character class", shape = rectangle, id = 0];1->0;}';
        
        $parser = $this->run_parser('[[:cntrl:]]{,5}');
        $root57 = $parser->get_root();        
        $etalon_dot_instructions57 = 'digraph {rankdir = LR;1[label = "{,5}", tooltip = "finite quantifier", id = 1];0[label = "[[:cntrl:]]", tooltip = "character class", shape = rectangle, id = 0];1->0;}';
        
        $parser = $this->run_parser('[[:graph:]]{0,0}');
        $root58 = $parser->get_root();        
        $etalon_dot_instructions58 = 'digraph {rankdir = LR;1[label = "{0,0}", tooltip = "finite quantifier", id = 1];0[label = "[[:graph:]]", tooltip = "character class", shape = rectangle, id = 0];1->0;}';
        
        $parser = $this->run_parser('[[:print:]]{2,7}');
        $root59 = $parser->get_root();        
        $etalon_dot_instructions59 = 'digraph {rankdir = LR;1[label = "{2,7}", tooltip = "finite quantifier", id = 1];0[label = "[[:print:]]", tooltip = "character class", shape = rectangle, id = 0];1->0;}';
        ...
        $etalon_dot_instructions61 = 'digraph {rankdir = LR;2[label = "concat", tooltip = concatenation, id = 2];0[label = "[[-]", tooltip = "character class", shape = rectangle, id = 0];1[label = "]", tooltip = "character class", shape = rectangle, id = 1];2->0;2->1;}';
        
        $parser = $this->run_parser('[[.NIL.]]');
        $root62 = $parser->get_root();
        $etalon_dot_instructions62 = 'digraph {rankdir = LR;0[label = "[[.NIL.]]", tooltip = "character class", shape = rectangle, id = 0];0;}';
        ...
        $etalon_dot_instructions64 = 'digraph {rankdir = LR;10[label = "concat", tooltip = concatenation, id = 10];8[label = "concat", tooltip = concatenation, id = 8];6[label = "concat", tooltip = concatenation, id = 6];4[label = "concat", tooltip = concatenation, id = 4];2[label = "concat", tooltip = concatenation, id = 2];0[label = "B", tooltip = "character class", shape = rectangle, id = 0];1[label = "E", tooltip = "character class", shape = rectangle, id = 1];3[label = "assertion $", tooltip = assertion, shape = rectangle, id = 3];5[label = "3", tooltip = "character class", shape = rectangle, id = 5];7[label = "3", tooltip = "character class", shape = rectangle, id = 7];9[label = "[!-\\w]", tooltip = "character class", shape = rectangle, id = 9];10->8->6->4->2->0;2->1;4->3;6->5;8->7;10->9;}';
        
        $parser = $this->run_parser('abc^');
        $root65 = $parser->get_root();
        $etalon_dot_instructions65 = 'digraph {rankdir = LR;6[label = "concat", tooltip = concatenation, id = 6];4[label = "concat", tooltip = concatenation, id = 4];2[label = "concat", tooltip = concatenation, id = 2];0[label = "a", tooltip = "character class", shape = rectangle, id = 0];1[label = "b", tooltip = "character class", shape = rectangle, id = 1];3[label = "c", tooltip = "character class", shape = rectangle, id = 3];5[label = "assertion ^", tooltip = assertion, shape = rectangle, id = 5];6->4->2->0;2->1;4->3;6->5;}';
        
        $parser = $this->run_parser('11111111111111111111111111111111111111111111111111111');
        $root66 = $parser->get_root();
        $etalon_dot_instructions66 = 'digraph {rankdir = LR;104[label = "concat", tooltip = concatenation, id = 104];102[label = "concat", tooltip = concatenation, id = 102];100[label = "concat", tooltip = concatenation, id = 100];98[label = "concat", tooltip = concatenation, id = 98];96[label = "concat", tooltip = concatenation, id = 96];94[label = "concat", tooltip = concatenation, id = 94];92[label = "concat", tooltip = concatenation, id = 92];90[label = "concat", tooltip = concatenation, id = 90];88[label = "concat", tooltip = concatenation, id = 88];86[label = "concat", tooltip = concatenation, id = 86];84[label = "concat", tooltip = concatenation, id = 84];82[label = "concat", tooltip = concatenation, id = 82];80[label = "concat", tooltip = concatenation, id = 80];78[label = "concat", tooltip = concatenation, id = 78];76[label = "concat", tooltip = concatenation, id = 76];74[label = "concat", tooltip = concatenation, id = 74];72[label = "concat", tooltip = concatenation, id = 72];70[label = "concat", tooltip = concatenation, id = 70];68[label = "concat", tooltip = concatenation, id = 68];66[label = "concat", tooltip = concatenation, id = 66];64[label = "concat", tooltip = concatenation, id = 64];62[label = "concat", tooltip = concatenation, id = 62];60[label = "concat", tooltip = concatenation, id = 60];58[label = "concat", tooltip = concatenation, id = 58];56[label = "concat", tooltip = concatenation, id = 56];54[label = "concat", tooltip = concatenation, id = 54];52[label = "concat", tooltip = concatenation, id = 52];50[label = "concat", tooltip = concatenation, id = 50];48[label = "concat", tooltip = concatenation, id = 48];46[label = "concat", tooltip = concatenation, id = 46];44[label = "concat", tooltip = concatenation, id = 44];42[label = "concat", tooltip = concatenation, id = 42];40[label = "concat", tooltip = concatenation, id = 40];38[label = "concat", tooltip = concatenation, id = 38];36[label = "concat", tooltip = concatenation, id = 36];34[label = "concat", tooltip = concatenation, id = 34];32[label = "concat", tooltip = concatenation, id = 32];30[label = "concat", tooltip = concatenation, id = 30];28[label = "concat", tooltip = concatenation, id = 28];26[label = "concat", tooltip = concatenation, id = 26];24[label = "concat", tooltip = concatenation, id = 24];22[label = "concat", tooltip = concatenation, id = 22];20[label = "concat", tooltip = concatenation, id = 20];18[label = "concat", tooltip = concatenation, id = 18];16[label = "concat", tooltip = concatenation, id = 16];14[label = "concat", tooltip = concatenation, id = 14];12[label = "concat", tooltip = concatenation, id = 12];10[label = "concat", tooltip = concatenation, id = 10];8[label = "concat", tooltip = concatenation, id = 8];6[label = "concat", tooltip = concatenation, id = 6];4[label = "concat", tooltip = concatenation, id = 4];2[label = "concat", tooltip = concatenation, id = 2];0[label = "1", tooltip = "character class", shape = rectangle, id = 0];1[label = "1", tooltip = "character class", shape = rectangle, id = 1];3[label = "1", tooltip = "character class", shape = rectangle, id = 3];5[label = "1", tooltip = "character class", shape = rectangle, id = 5];7[label = "1", tooltip = "character class", shape = rectangle, id = 7];9[label = "1", tooltip = "character class", shape = rectangle, id = 9];11[label = "1", tooltip = "character class", shape = rectangle, id = 11];13[label = "1", tooltip = "character class", shape = rectangle, id = 13];15[label = "1", tooltip = "character class", shape = rectangle, id = 15];17[label = "1", tooltip = "character class", shape = rectangle, id = 17];19[label = "1", tooltip = "character class", shape = rectangle, id = 19];21[label = "1", tooltip = "character class", shape = rectangle, id = 21];23[label = "1", tooltip = "character class", shape = rectangle, id = 23];25[label = "1", tooltip = "character class", shape = rectangle, id = 25];27[label = "1", tooltip = "character class", shape = rectangle, id = 27];29[label = "1", tooltip = "character class", shape = rectangle, id = 29];31[label = "1", tooltip = "character class", shape = rectangle, id = 31];33[label = "1", tooltip = "character class", shape = rectangle, id = 33];35[label = "1", tooltip = "character class", shape = rectangle, id = 35];37[label = "1", tooltip = "character class", shape = rectangle, id = 37];39[label = "1", tooltip = "character class", shape = rectangle, id = 39];41[label = "1", tooltip = "character class", shape = rectangle, id = 41];43[label = "1", tooltip = "character class", shape = rectangle, id = 43];45[label = "1", tooltip = "character class", shape = rectangle, id = 45];47[label = "1", tooltip = "character class", shape = rectangle, id = 47];49[label = "1", tooltip = "character class", shape = rectangle, id = 49];51[label = "1", tooltip = "character class", shape = rectangle, id = 51];53[label = "1", tooltip = "character class", shape = rectangle, id = 53];55[label = "1", tooltip = "character class", shape = rectangle, id = 55];57[label = "1", tooltip = "character class", shape = rectangle, id = 57];59[label = "1", tooltip = "character class", shape = rectangle, id = 59];61[label = "1", tooltip = "character class", shape = rectangle, id = 61];63[label = "1", tooltip = "character class", shape = rectangle, id = 63];65[label = "1", tooltip = "character class", shape = rectangle, id = 65];67[label = "1", tooltip = "character class", shape = rectangle, id = 67];69[label = "1", tooltip = "character class", shape = rectangle, id = 69];71[label = "1", tooltip = "character class", shape = rectangle, id = 71];73[label = "1", tooltip = "character class", shape = rectangle, id = 73];75[label = "1", tooltip = "character class", shape = rectangle, id = 75];77[label = "1", tooltip = "character class", shape = rectangle, id = 77];79[label = "1", tooltip = "character class", shape = rectangle, id = 79];81[label = "1", tooltip = "character class", shape = rectangle, id = 81];83[label = "1", tooltip = "character class", shape = rectangle, id = 83];85[label = "1", tooltip = "character class", shape = rectangle, id = 85];87[label = "1", tooltip = "character class", shape = rectangle, id = 87];89[label = "1", tooltip = "character class", shape = rectangle, id = 89];91[label = "1", tooltip = "character class", shape = rectangle, id = 91];93[label = "1", tooltip = "character class", shape = rectangle, id = 93];95[label = "1", tooltip = "character class", shape = rectangle, id = 95];97[label = "1", tooltip = "character class", shape = rectangle, id = 97];99[label = "1", tooltip = "character class", shape = rectangle, id = 99];101[label = "1", tooltip = "character class", shape = rectangle, id = 101];103[label = "1", tooltip = "character class", shape = rectangle, id = 103];104->102->100->98->96->94->92->90->88->86->84->82->80->78->76->74->72->70->68->66->64->62->60->58->56->54->52->50->48->46->44->42->40->38->36->34->32->30->28->26->24->22->20->18->16->14->12->10->8->6->4->2->0;2->1;4->3;6->5;8->7;10->9;12->11;14->13;16->15;18->17;20->19;22->21;24->23;26->25;28->27;30->29;32->31;34->33;36->35;38->37;40->39;42->41;44->43;46->45;48->47;50->49;52->51;54->53;56->55;58->57;60->59;62->61;64->63;66->65;68->67;70->69;72->71;74->73;76->75;78->77;80->79;82->81;84->83;86->85;88->87;90->89;92->91;94->93;96->95;98->97;100->99;102->101;104->103;}';
        /*
        $regexhandler = new qtype_preg_regex_handler();
        $dir = $regexhandler->get_temp_dir('nodes');
        qtype_preg_regex_handler::execute_dot($root66->dot_script(new qtype_preg_dot_style_provider()), $dir . 'ast_test.png');
        var_dump($root66->dot_script(new qtype_preg_dot_style_provider()));
        */
        $this->assertTrue($etalon_dot_instructions1 === $root1->dot_script(new qtype_preg_dot_style_provider()),'Test with regex (a|) failed!');
        $this->assertTrue($etalon_dot_instructions2 === $root2->dot_script(new qtype_preg_dot_style_provider()),'Test with regex ^\\\\a\\b\\A\\Z\\G$ failed!');
        $this->assertTrue($etalon_dot_instructions3 === $root3->dot_script(new qtype_preg_dot_style_provider()),'Test with regex abc[\\w\\W\\s\\S\\d\\D\\h\\H\\v\\V] failed!');
        $this->assertTrue($etalon_dot_instructions4 === $root4->dot_script(new qtype_preg_dot_style_provider()),'Test with regex abc[\\w\\W\\s] failed!');
        $this->assertTrue($etalon_dot_instructions5 === $root5->dot_script(new qtype_preg_dot_style_provider()),'Test with regex abc[\\S\\d\\D] failed!');
        $this->assertTrue($etalon_dot_instructions6 === $root6->dot_script(new qtype_preg_dot_style_provider()),'Test with regex 345[\\h\\H\\v\\V] failed!');
        $this->assertTrue($etalon_dot_instructions7 === $root7->dot_script(new qtype_preg_dot_style_provider()),'Test with regex abc[^\\w\\W\\s\\S\\d\\D\\h\\H\\v\\V] failed!');
        $this->assertTrue($etalon_dot_instructions8 === $root8->dot_script(new qtype_preg_dot_style_provider()),'Test with regex abc[^\\w\\W\\s] failed!');
        $this->assertTrue($etalon_dot_instructions9 === $root9->dot_script(new qtype_preg_dot_style_provider()),'Test with regex abc[^\\S\\d\\D] failed!');
        $this->assertTrue($etalon_dot_instructions10 === $root10->dot_script(new qtype_preg_dot_style_provider()),'Test with regex 345[^\\h\\H\\v\\V] failed!');
        $this->assertTrue($etalon_dot_instructions11 === $root11->dot_script(new qtype_preg_dot_style_provider()),'Test with regex abc\\w\\W\\s\\S\\d\\D\\h\\H\\v\\V failed!');
        $this->assertTrue($etalon_dot_instructions12 === $root12->dot_script(new qtype_preg_dot_style_provider()),'Test with regex abc\\w\\W\\s failed!');
        $this->assertTrue($etalon_dot_instructions13 === $root13->dot_script(new qtype_preg_dot_style_provider()),'Test with regex abc\\S\\d\\D failed!');
        $this->assertTrue($etalon_dot_instructions14 === $root14->dot_script(new qtype_preg_dot_style_provider()),'Test with regex 345\\h\\H\\v\\V failed!');
        $this->assertTrue($etalon_dot_instructions15 === $root15->dot_script(new qtype_preg_dot_style_provider()),'Test with regex [a-z2-5]33* failed!');
        $this->assertTrue($etalon_dot_instructions16 === $root16->dot_script(new qtype_preg_dot_style_provider()),'Test with regex [B-D!.].{1,5}23? failed!');
        $this->assertTrue($etalon_dot_instructions17 === $root17->dot_script(new qtype_preg_dot_style_provider()),'Test with regex \\A[^c-z;-](ef)+ failed!');
        $this->assertTrue($etalon_dot_instructions18 === $root18->dot_script(new qtype_preg_dot_style_provider()),'Test with regex abc{3,7} failed!');
        $this->assertTrue($etalon_dot_instructions19 === $root19->dot_script(new qtype_preg_dot_style_provider()),'Test with regex abc{3,} failed!');
        $this->assertTrue($etalon_dot_instructions20 === $root20->dot_script(new qtype_preg_dot_style_provider()),'Test with regex abc{,7} failed!');
        $this->assertTrue($etalon_dot_instructions21 === $root21->dot_script(new qtype_preg_dot_style_provider()),'Test with regex abc{0,7} failed!');
        $this->assertTrue($etalon_dot_instructions22 === $root22->dot_script(new qtype_preg_dot_style_provider()),'Test with regex [^a-z]*? failed!');
        $this->assertTrue($etalon_dot_instructions23 === $root23->dot_script(new qtype_preg_dot_style_provider()),'Test with regex [^A-Z]+? failed!');
        $this->assertTrue($etalon_dot_instructions24 === $root24->dot_script(new qtype_preg_dot_style_provider()),'Test with regex [^3-9]{5,}? failed!');
        $this->assertTrue($etalon_dot_instructions25 === $root25->dot_script(new qtype_preg_dot_style_provider()),'Test with regex [^\W33]*+ failed!');
        $this->assertTrue($etalon_dot_instructions26 === $root26->dot_script(new qtype_preg_dot_style_provider()),'Test with regex [^\D\S]?+ failed!');
        $this->assertTrue($etalon_dot_instructions27 === $root27->dot_script(new qtype_preg_dot_style_provider()),'Test with regex [^\w\d]{5,}+ failed!');
        $this->assertTrue($etalon_dot_instructions28 === $root28->dot_script(new qtype_preg_dot_style_provider()),'Test with regex ab(xa)*+a failed!');
        $this->assertTrue($etalon_dot_instructions29 === $root29->dot_script(new qtype_preg_dot_style_provider()),'Test with regex a(bc|b|x)cc failed!');
        $this->assertTrue($etalon_dot_instructions30 === $root30->dot_script(new qtype_preg_dot_style_provider()),'Test with regex a(?:bc|b|x)cc failed!');
        $this->assertTrue($etalon_dot_instructions31 === $root31->dot_script(new qtype_preg_dot_style_provider()),'Test with regex a(?>bc|b|x)cc failed!');
        $this->assertTrue($etalon_dot_instructions32 === $root32->dot_script(new qtype_preg_dot_style_provider()),'Test with regex a(?>x*)xa failed!');
        $this->assertTrue($etalon_dot_instructions33 === $root33->dot_script(new qtype_preg_dot_style_provider()),'Test with regex (?-i)(?i:tv)set failed!');
        $this->assertTrue($etalon_dot_instructions34 === $root34->dot_script(new qtype_preg_dot_style_provider()),'Test with regex my name is (?=Freedom) failed!');
        $this->assertTrue($etalon_dot_instructions35 === $root35->dot_script(new qtype_preg_dot_style_provider()),'Test with regex my name is (?!Freedom) failed!');
        $this->assertTrue($etalon_dot_instructions36 === $root36->dot_script(new qtype_preg_dot_style_provider()),'Test with regex my name is (?<=Freedom) failed!');
        $this->assertTrue($etalon_dot_instructions37 === $root37->dot_script(new qtype_preg_dot_style_provider()),'Test with regex my name is (?<!Freedom) failed!');
        $this->assertTrue($etalon_dot_instructions38 === $root38->dot_script(new qtype_preg_dot_style_provider()),'Test with regex (?(?<=a)m|d) failed!');
        $this->assertTrue($etalon_dot_instructions39 === $root39->dot_script(new qtype_preg_dot_style_provider()),'Test with regex (a)?(?(?1)m|d) failed!');
        $this->assertTrue($etalon_dot_instructions40 === $root40->dot_script(new qtype_preg_dot_style_provider()),'Test with regex a\.? failed!');
        $this->assertTrue($etalon_dot_instructions41 === $root41->dot_script(new qtype_preg_dot_style_provider()),'Test with regex a\\\\b failed!');
        $this->assertTrue($etalon_dot_instructions42 === $root42->dot_script(new qtype_preg_dot_style_provider()),'Test with regex a\[F\] failed!');
        $this->assertTrue($etalon_dot_instructions43 === $root43->dot_script(new qtype_preg_dot_style_provider()),'Test with regex \Q+-*/\E failed!');
        $this->assertTrue($etalon_dot_instructions44 === $root44->dot_script(new qtype_preg_dot_style_provider()),'Test with regex (a+a+)+a failed!');
        $this->assertTrue($etalon_dot_instructions45 === $root45->dot_script(new qtype_preg_dot_style_provider()),'Test with regex :::1:::0:|:::1:1:0: failed!');
        $this->assertTrue($etalon_dot_instructions46 === $root46->dot_script(new qtype_preg_dot_style_provider()),'Test with regex :::1:::0:|:::1:1:1::: failed!');
        $this->assertTrue($etalon_dot_instructions47 === $root47->dot_script(new qtype_preg_dot_style_provider()),'Test with regex [[:upper:]]A failed!');
        $this->assertTrue($etalon_dot_instructions48 === $root48->dot_script(new qtype_preg_dot_style_provider()),'Test with regex [[:lower:]]+az failed!');
        $this->assertTrue($etalon_dot_instructions49 === $root49->dot_script(new qtype_preg_dot_style_provider()),'Test with regex [[:alpha:]]*35 failed!');
        $this->assertTrue($etalon_dot_instructions50 === $root50->dot_script(new qtype_preg_dot_style_provider()),'Test with regex [[:digit:]]?Z failed!');
        $this->assertTrue($etalon_dot_instructions51 === $root51->dot_script(new qtype_preg_dot_style_provider()),'Test with regex [[:xdigit:]]|3AZ failed!');
        $this->assertTrue($etalon_dot_instructions52 === $root52->dot_script(new qtype_preg_dot_style_provider()),'Test with regex [[:alnum:]]**a failed!');
        $this->assertTrue($etalon_dot_instructions53 === $root53->dot_script(new qtype_preg_dot_style_provider()),'Test with regex [[:word:]][2-4!] failed!');
        $this->assertTrue($etalon_dot_instructions54 === $root54->dot_script(new qtype_preg_dot_style_provider()),'Test with regex [[:punct:]][^3333] failed!');
        $this->assertTrue($etalon_dot_instructions55 === $root55->dot_script(new qtype_preg_dot_style_provider()),'Test with regex [[:blank:]](a|b) failed!');
        $this->assertTrue($etalon_dot_instructions56 === $root56->dot_script(new qtype_preg_dot_style_provider()),'Test with regex [[:space:]]{3,} failed!');
        $this->assertTrue($etalon_dot_instructions57 === $root57->dot_script(new qtype_preg_dot_style_provider()),'Test with regex [[:cntrl:]]{,5} failed!');
        $this->assertTrue($etalon_dot_instructions58 === $root58->dot_script(new qtype_preg_dot_style_provider()),'Test with regex [[:graph:]]{0,0} failed!');
        $this->assertTrue($etalon_dot_instructions59 === $root59->dot_script(new qtype_preg_dot_style_provider()),'Test with regex [[:print:]]{2,7} failed!');
        $this->assertTrue($etalon_dot_instructions60 === $root60->dot_script(new qtype_preg_dot_style_provider()),'Test with regex (ab|cd*$|){3,100} failed!');
        $this->assertTrue($etalon_dot_instructions61 === $root61->dot_script(new qtype_preg_dot_style_provider()),'Test with regex [[-]] failed!');
        $this->assertTrue($etalon_dot_instructions62 === $root62->dot_script(new qtype_preg_dot_style_provider()),'Test with regex [[.NIL.]] failed!');
        $this->assertTrue($etalon_dot_instructions63 === $root63->dot_script(new qtype_preg_dot_style_provider()),'Test with regex [[=aleph=]](NULL)? failed!');
        $this->assertTrue($etalon_dot_instructions64 === $root64->dot_script(new qtype_preg_dot_style_provider()),'Test with regex BE$33[\w!-] failed!');
        $this->assertTrue($etalon_dot_instructions65 === $root65->dot_script(new qtype_preg_dot_style_provider()),'Test with regex abc^ failed!');
        $this->assertTrue($etalon_dot_instructions66 === $root66->dot_script(new qtype_preg_dot_style_provider()),'Test with regex 11111111111111111111111111111111111111111111111111111 failed!');
