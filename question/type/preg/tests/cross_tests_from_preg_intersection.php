...
class qtype_preg_cross_tests_from_preg_intersection {
    ...
    function data_for_test_assertions_lookahead_43() {
        $test1 = array( 'str'=>'abc',
                        'is_match'=>true,
                        'full'=>true,
                        'index_first'=>array(0=>0, 1=>1),
        ...
        $test2 = array( 'str'=>'abcbcbc',
                        'is_match'=>true,
                        'full'=>true,
                        'index_first'=>array(0=>0, 1=>5),
                        'length'=>array(0=>7, 1=>2));

        $test3 = array( 'str'=>'abcbk',
                        'is_match'=>true,
                        'full'=>true,
                        'index_first'=>array(0=>0, 1=>1),
                        'length'=>array(0=>3, 1=>2));

        return array('regex'=>'a((?=bc)[bd][ck])+',
                     'tests'=>array($test1, $test2, $test3),
                     'tags'=>array(qtype_preg_cross_tester::TAG_FAIL_MODE_MERGE));
    }

    function data_for_test_assertions_lookahead_44() {
        ...
        $test2 = array( 'str'=>'abcdbcdbcd',
                        'is_match'=>true,
                        'full'=>true,
                        'index_first'=>array(0=>0, 1=>7),
                        'length'=>array(0=>10, 1=>3));

        $test3 = array( 'str'=>'abcdbk',
                        'is_match'=>true,
                        'full'=>true,
                        'index_first'=>array(0=>0, 1=>1),
                        'length'=>array(0=>4, 1=>3));

        return array('regex'=>'a((?=bc)[bd][ck]d)+',
                     'tests'=>array($test1, $test2, $test3),
                     'tags'=>array(qtype_preg_cross_tester::TAG_FAIL_MODE_MERGE));
    }

    function data_for_test_assertions_lookahead_45() {
        $test1 = array( 'str'=>'abc',
                        'is_match'=>true,
                        'full'=>true,
                        'index_first'=>array(0=>0, 1=>1),
    ...
    function data_for_test_assertions_lookahead_46() {
        $test1 = array( 'str'=>'abcd',
                        'is_match'=>true,
                        'full'=>true,
                        'index_first'=>array(0=>0, 1=>1),
    ...
    function data_for_test_assertions_lookbehind_34() {
        $test1 = array( 'str'=>'abc',
                        'is_match'=>true,
                        'full'=>true,
                        'index_first'=>array(0=>0, 1=>1),
        ...
        return array('regex'=>'a([bd][ck](?<=bc))+',
                     'tests'=>array($test1, $test2, $test3),
                     'tags'=>array(qtype_preg_cross_tester::TAG_FAIL_MODE_MERGE));
    }

    function data_for_test_assertions_lookbehind_35() {
        $test1 = array( 'str'=>'abcd',
                        'is_match'=>true,
                        'full'=>true,
                        'index_first'=>array(0=>0, 1=>1),
        ...
        return array('regex'=>'a([bd][ck](?<=bc)d)+',
                     'tests'=>array($test1, $test2, $test3),
                     'tags'=>array(qtype_preg_cross_tester::TAG_FAIL_MODE_MERGE));
    }

    function data_for_test_assertions_lookbehind_36() {
        $test1 = array( 'str'=>'abc',
                        'is_match'=>true,
                        'full'=>true,
                        'index_first'=>array(0=>0, 1=>1),
    ...
    function data_for_test_assertions_lookbehind_37() {
        $test1 = array( 'str'=>'abcd',
                        'is_match'=>true,
                        'full'=>true,
                        'index_first'=>array(0=>0, 1=>1),
    ...
    function data_for_test_assertions_lookbehind_38() {
        $test1 = array( 'str'=>'abc',
                        'is_match'=>true,
                        'full'=>true,
                        'index_first'=>array(0=>0),
        ...
        return array('regex'=>'ab(c(?<=bc)d[be])*',
                     'tests'=>array($test1, $test2, $test3, $test4),
                     'tags'=>array(qtype_preg_cross_tester::TAG_FAIL_MODE_MERGE));
    }

    function data_for_test_assertions_lookbehind_39() {
        $test1 = array( 'str'=>'abc',
                        'is_match'=>true,
                        'full'=>true,
                        'index_first'=>array(0=>0, 1=>1),
        ...
        return array('regex'=>'a(b(c(?<=bc)d[be])*|[b-z]{2}k)',
                     'tests'=>array($test1, $test2, $test3, $test4, $test5),
                     'tags'=>array(qtype_preg_cross_tester::TAG_FAIL_MODE_MERGE));
    }

    /*function data_for_test_assertions_lookbehind_40() {
        $test1 = array( 'str'=>'abc',
                        'is_match'=>true,
                        'full'=>true,
                        'index_first'=>array(0=>0, 1=>1),
        ...
        return array('regex'=>'a(bc(?<=(bc))de)*',
                     'tests'=>array($test1, $test2, $test3, $test4),
                     'tags'=>array(qtype_preg_cross_tester::TAG_FAIL_MODE_MERGE));
    }*/

    /*function data_for_test_assertions_lookbehind_41() {
        $test1 = array( 'str'=>'abc',
                        'is_match'=>true,
                        'full'=>true,
                        'index_first'=>array(0=>0, 1=>1, 2=>1),
        ...
        return array('regex'=>'a((bc(?<=(bc))de)*|[a-z][a-c]k)',
                     'tests'=>array($test1, $test2, $test3, $test4, $test5),
                     'tags'=>array(qtype_preg_cross_tester::TAG_FAIL_MODE_MERGE));
    }*/

    function data_for_test_assertions_lookbehind_42() {
        $test1 = array( 'str'=>'a',
                        'is_match'=>true,
                        'full'=>true,
                        'index_first'=>array(0=>0),
        ...
        return array('regex'=>'a(bcde(?<=(de)))*',
                     'tests'=>array($test1, $test2, $test3),
                     'tags'=>array(qtype_preg_cross_tester::TAG_FAIL_MODE_MERGE));
    }

    function data_for_test_assertions_lookbehind_43() {
        $test1 = array( 'str'=>'a',
                        'is_match'=>true,
                        'full'=>true,
                        'index_first'=>array(0=>0),
    ...
    function data_for_test_assertions_lookbehind_44() {
        $test1 = array( 'str'=>'abcde',
                        'is_match'=>true,
                        'full'=>true,
                        'index_first'=>array(0=>0, 1=>1),
        ...
        return array('regex'=>'a(bcd(?<=cd)e)+',
                     'tests'=>array($test1, $test2, $test3),
                     'tags'=>array(qtype_preg_cross_tester::TAG_FAIL_MODE_MERGE));
    }

    function data_for_test_assertions_lookbehind_45() {
        $test1 = array( 'str'=>'abcde',
                        'is_match'=>true,
                        'full'=>true,
                        'index_first'=>array(0=>0, 1=>1, 2=>2),
        ...
        $test5 = array( 'str'=>'ab',
                        'is_match'=>true,
                        'full'=>false,
                        'index_first'=>array(0=>0, 2=>2),
                        'length'=>array(0=>2, 2=>0),
                        'left'=>array(1),
                        'next'=>'e');
    ...
    function data_for_test_assertions_lookbehind_46() {
        $test1 = array( 'str'=>'abcdefk',
                        'is_match'=>true,
                        'full'=>true,
                        'index_first'=>array(0=>0, 1=>1),
                        'length'=>array(0=>7, 1=>3));

        $test2 = array( 'str'=>'abcdbcdefk',
                        'is_match'=>true,
                        'full'=>true,
                        'index_first'=>array(0=>0, 1=>4),
                        'length'=>array(0=>10, 1=>3));

        return array('regex'=>'a(bcd)+ef(?<=cdef)k',
                     'tests'=>array($test1, $test2),
                     'tags'=>array(qtype_preg_cross_tester::TAG_FAIL_MODE_MERGE));
    }

    function data_for_test_assertions_lookbehind_47() {
        $test1 = array( 'str'=>'cdcd',
                        'is_match'=>true,
                        'full'=>true,
                        'index_first'=>array(0=>2, 1=>0),
                        'length'=>array(0=>2, 1=>3));

        $test2 = array( 'str'=>'cdcdcd',
                        'is_match'=>true,
                        'full'=>true,
                        'index_first'=>array(0=>4, 1=>2),
                        'length'=>array(0=>4, 1=>3));

        $test3 = array( 'str'=>'bdcdbd',
                        'is_match'=>false,
                        'full'=>false,
                        'index_first'=>array(),
                        'length'=>array(),
        ...
        return array('regex'=>'([bc](?<=cdc)[cd])+',
                     'tests'=>array($test1, $test2, $test3),
                     'tags'=>array(qtype_preg_cross_tester::TAG_FAIL_MODE_MERGE));
    }

    function data_for_test_assertions_lookbehind_48() {
        $test1 = array( 'str'=>'abcd',
                        'is_match'=>true,
                        'full'=>true,
                        'index_first'=>array(0=>0, 1=>1, 2=>1),
        ...
        $test2 = array( 'str'=>'abcdbcd',
                        ...
                        'length'=>array(0=>7, 1=>3, 5=>2));

        $test3 = array( 'str'=>'aafabcd',
                        'is_match'=>true,
                        'full'=>true,
                        'index_first'=>array(0=>3, 1=>4, 2=>4),
                        'length'=>array(0=>4, 1=>3, 2=>2));
    ...
    function data_for_test_inner_assertions_1() {
        $test1 = array( 'str'=>'cabcd',
                        'is_match'=>true,
                        'full'=>true,
                        'index_first'=>array(0=>0),
                        'length'=>array(0=>4));

        $test2 = array( 'str'=>'cablf',
                        'is_match'=>true,
                        'full'=>false,
                        'index_first'=>array(0=>0),
                        'length'=>array(0=>3),
        ...
        return array('regex'=>'c(?=ab(?=cd)[a-l][a-f])[a-x]{3}',
                     'tests'=>array($test1, $test2),
                     'tags'=>array(qtype_preg_cross_tester::TAG_FAIL_MODE_MERGE));
    }

    function data_for_test_inner_assertions_2() {
        $test1 = array( 'str'=>'cablf',
                        'is_match'=>true,
                        'full'=>true,
                        'index_first'=>array(0=>0),
                        'length'=>array(0=>4));

        $test2 = array( 'str'=>'cabll',
                        'is_match'=>true,
                        'full'=>false,
                        'index_first'=>array(0=>0),
                        'length'=>array(0=>4),
        ...
        $test4 = array( 'str'=>'cablaf',
                        'is_match'=>true,
                        'full'=>true,
                        'index_first'=>array(0=>0),
                        'length'=>array(0=>4));

        $test5 = array( 'str'=>'cabl',
                        'is_match'=>true,
                        'full'=>false,
                        'index_first'=>array(0=>0),
                        'length'=>array(0=>4),
        ...
        return array('regex'=>'[cd](?=ab(?<=cab)[a-l][a-f])[a-x]{3}',
                     'tests'=>array($test1, $test2, $test3, $test4, $test5),
                     'tags'=>array(qtype_preg_cross_tester::TAG_FAIL_MODE_MERGE));
    }

    function data_for_test_inner_assertions_3() {
        $test1 = array( 'str'=>'',
                        'is_match'=>true,
                        'full'=>true,
                        'index_first'=>array(0=>0),
    ...
    function data_for_test_inner_assertions_4() {
        $test1 = array( 'str'=>'',
                        'is_match'=>true,
                        'full'=>true,
                        'index_first'=>array(0=>0),
    ...
    function data_for_test_inner_assertions_5() {
        $test1 = array( 'str'=>'abc',
                        'is_match'=>true,
                        'full'=>true,
                        'index_first'=>array(0=>0, 1=>1),
        ...
        return array('regex'=>'(?=(?=a(b|))a[a-z]c)a[a-f]+',
                     'tests'=>array($test1, $test2, $test3, $test4),
                     'tags'=>array(qtype_preg_cross_tester::TAG_FAIL_MODE_MERGE));
    }

    function data_for_test_inner_assertions_6() {
        $test1 = array( 'str'=>'bas',
                        'is_match'=>true,
                        'full'=>true,
                        'index_first'=>array(0=>0, 1=>1),
        ...
        return array('regex'=>'b(?=[ax]s(?<=(a|)[s-z]))[a-k][s-z]',
                     'tests'=>array($test1, $test2, $test3),
                     'tags'=>array(qtype_preg_cross_tester::TAG_FAIL_MODE_MERGE));
    }

    function data_for_test_inner_assertions_7() {
        $test1 = array( 'str'=>'abcd',
                        'is_match'=>true,
                        'full'=>true,
                        'index_first'=>array(0=>0, 1=>0, 2=>0, 3=>2, 4=>0),
                        'length'=>array(0=>4, 1=>4, 2=>2, 3=>0, 4=>2));
        ...
        return array('regex'=>'(abcd|)(?<=(ab(c|))(?<=(ab)|)cd)',
                     'tests'=>array($test1, $test2, $test3),
                     'tags'=>array(qtype_preg_cross_tester::TAG_FAIL_MODE_MERGE));
    }

    function data_for_test_inner_assertions_8() {
        $test1 = array( 'str'=>'kabc',
                        'is_match'=>true,
                        'full'=>true,
                        'index_first'=>array(0=>0, 1=>2, 2=>0),
                        'length'=>array(0=>4, 1=>1, 2=>1));
        ...
        $test3 = array( 'str'=>'zabc',
                        'is_match'=>true,
                        'full'=>true,
                        'index_first'=>array(0=>0, 1=>2, 2=>1),
                        'length'=>array(0=>4, 1=>1, 2=>0));

        return array('regex'=>'[k-z](?=(?=a(b|))abc(?<=(k|)abc))abc',
                     'tests'=>array($test1, $test2, $test3),
                     'tags'=>array(qtype_preg_cross_tester::TAG_FAIL_MODE_MERGE));
    }

    function data_for_test_inner_assertions_9() {
        $test1 = array( 'str'=>'abcbcde',
                        'is_match'=>true,
                        'full'=>true,
                        'index_first'=>array(0=>0, 1=>3, 2=>3),
                        'length'=>array(0=>7, 1=>2, 2=>2));

        $test2 = array( 'str'=>'abcbcbcde',
                        'is_match'=>true,
                        'full'=>false,
                        'index_first'=>array(0=>0, 1=>3, 2=>3),
                        'length'=>array(0=>5, 1=>2, 2=>2),
        ...
        return array('regex'=>'abcbcd(?<=a(bc){0,3}(?<=a(bc)+)d)e',
                     'tests'=>array($test1, $test2),
                     'tags'=>array(qtype_preg_cross_tester::TAG_FAIL_MODE_MERGE));
    }

    function data_for_test_inner_assertions_10() {
        $test1 = array( 'str'=>'dab',
                        'is_match'=>true,
                        'full'=>true,
                        'index_first'=>array(0=>0, 1=>0, 2=>1, 3=>0, 4=>1),
                        'length'=>array(0=>3, 1=>1, 2=>1, 3=>2, 4=>1));
    ...
    function data_for_test_inner_assertions_11() {
    ...
    function data_for_test_inner_assertions_12() {
        $test1 = array( 'str'=>'',
                        'is_match'=>true,
                        'full'=>true,
                        'index_first'=>array(0=>0),
    ...
    function data_for_test_inner_assertions_13() {
        $test1 = array( 'str'=>'',
                        'is_match'=>true,
                        'full'=>true,
                        'index_first'=>array(0=>0),
