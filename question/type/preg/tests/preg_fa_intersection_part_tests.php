...
class qtype_preg_fa_intersection_part_test extends PHPUnit_Framework_TestCase {
    ...
    public function test_no_intersection() {
        ...
        $startstate = $direct->states[$direct->find_state_index(0, 0)];
        $resultautomata = $firstautomata->intersection_part($secondautomata, $direct, $startstate, 0);
    ...
    public function test_intersection_with_end() {
        ...
        $startstate = $direct->states[$direct->find_state_index(2, 3)];
        $resultautomata = $firstautomata->intersection_part($secondautomata, $direct, $startstate, 1);
        $result = $resultautomata->write_fa();
        $search = '
                    ';
        $replace = '\n';
    ...
    public function test_intersection_with_start() {
        ...
        $startstate = $direct->states[$direct->find_state_index(1, 0)];
        $resultautomata = $firstautomata->intersection_part($secondautomata, $direct, $startstate, 0);
        $result = $resultautomata->write_fa();
        $search = '
                    ';
    ...
    public function test_intersection_with_unmerged_eps() {
        ...
        $startstate = $direct->states[$direct->find_state_index(2, 2)];
        $resultautomata = $firstautomata->intersection_part($secondautomata, $direct, $startstate, 1);
        $result = $resultautomata->write_fa();
        $search = '
                    ';
        ...
        $dotresult = 'digraph res 
                    {
                        ...
                        "5,1";"5,2";
                        "0,"->"1,0"[label="[01]",color=violet];
                        "1,0"->"2,1"[label="[c-k]",color=red];
                        "2,1"->"4,1"[label="[a-c]",color=red];
                        "2,1"->"4,2"[label="[a-c]",color=red];
                        "4,1"->"5,1"[label="[xy]",color=red];
                        "4,1"->"5,2"[label="[xy]",color=red];
                    }';
        ...
        $dotresult = 'digraph res 
                    {
                        ...
                        "4,3";
                        "0,"->"1,0"[label="[01]",color=violet];
                        "1,0"->"2,1"[label="[cd]",color=red];
                        "2,1"->"3,2"[label="[a]",color=red];
                        "3,2"->"4,3"[label="[ab]",color=red];
                        "3,2"->"2,1"[label="[xy]",color=red];
                    }';
