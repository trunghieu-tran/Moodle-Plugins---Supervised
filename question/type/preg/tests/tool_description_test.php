...
class qtype_preg_tool_description_test extends PHPUnit_Framework_TestCase {
    ...
    public function test_charset($regex,$expected_en,$expected_ru)
    {
        ...
        $result = $handler->description('%%tests%%','%s');
        $this->assertEquals($expected_en, $result);
    }
    public function charset_provider()
    {
        return array(
          array('[^[:^word:]abc\pL]','any symbol except the following: not word character, letter, <span style="color:blue">a</span>, <span style="color:blue">b</span>, <span style="color:blue">c</span>;','любой символ кроме следующих: не символ слова, буква, <span style="color:blue">a</span>, <span style="color:blue">b</span>, <span style="color:blue">c</span>;','рус - TODO'),
          array('a','<span style="color:blue">a</span>','рус - TODO'),
          array('[^a]','not <span style="color:blue">a</span>','рус - TODO'),
          array('\w','word character','рус - TODO'),
          array('\W','not word character','рус - TODO'),
          ...
          array('[\x00-\xFF]','any character form null character(NUL) to <span style="color:blue">ÿ</span>','рус - TODO'),
          ...
          array('[\x{FF}-\x{1FF}]','any character form <span style="color:blue">ÿ</span> to <span style="color:blue">ǿ</span>','рус - TODO'),
          array('[a-z]','any character form <span style="color:blue">a</span> to <span style="color:blue">z</span>','рус - TODO'),
          ...
          array('[\x00\r\x22-\x3C\t]','one of the following characters: null character(NUL), carriage return character(CR), any character form <span style="color:blue">&#34;</span> to <span style="color:blue">&#60;</span>, tabulation(HT);','рус - TODO'),
          array('[ÿ-ƎƏ-ǿ]','any character form <span style="color:blue">ÿ</span> to <span style="color:blue">ǿ</span>','рус - TODO'),
    ...
    {
        return array(
          array('^','beginning of the string','рус - TODO'),
          array('$','end of the string','рус - TODO'),
          array('\b','at a word boundary','рус - TODO'),
    ...
    public function quant_provider()
    {
        return array(
          ...
          array('g+','<span style="color:blue">g</span> is repeated any number of times','рус - TODO'),
          array('g*','<span style="color:blue">g</span> is repeated any number of times or missing','рус - TODO'),
