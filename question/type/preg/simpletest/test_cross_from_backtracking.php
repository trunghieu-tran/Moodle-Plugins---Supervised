...
class test_cross_from_backtracking extends preg_cross_tester {
    ...
    /*function data_for_test_BACKREF_5() {
        $test0 = array( 'str'=>'abefabababababef',
                        ...
                        'left'=>array(0),
                        'next'=>'');
        $test1 = array( 'str'=>'cdghabghghef',        // TODO
                        'is_match'=>true,
                        'full'=>false,
                        'index_first'=>array(0=>0),
                        'index_last'=>array(0=>4),
