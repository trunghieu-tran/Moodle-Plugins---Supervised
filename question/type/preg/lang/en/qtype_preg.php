...
$string['correctanswer_help'] = 'Enter one of the correct answer in user-readable form to be shown to the student. If you leave it empty matching engine would try to generate correct answer itself, taking heed to get closest one to the student\'s response. For now only NFA engine could generate correct answers.';
