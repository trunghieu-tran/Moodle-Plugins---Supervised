...
$string['condsubexpr_too_much_alter_node_error']   = 'Syntax error: three or more top-level alternations in the conditional subexpression in position from {$a->colfirst} to {$a->collast}. Use parentheses if you want to include alternations in yes-expr on no-expr.';
...
$string['description_charflag_blank'] = 'space or tab only';
...
$string['description_charflag_hspace'] = 'horizontal whitespace character';//TODO
$string['description_charflag_vspace'] = 'vertical whitespace character';//TOOD
