...
$string['hintnextlexem'] = 'Следующий(ая) правильный(ая) {$a}';
...
$string['notation_help'] = '<p>Вы можете указать нотацию регулярных выражений. Если вы хотите просто использовать регулярные выражения, используйте нотацию <b>Регулярное выражение</b>.</p><p>Нотация <b>Moodle shortanswer</b> позволяет использовать preg как обычный вопрос Moodle shortanswer, но с поддержкой подсказок - не нужно понимать регулярные выражения. Просто скопируйте ваши ответы из shortanswer вопросов. Поддерживается \'*\'.</p>';
...
$string['unsupported'] = '{$a->nodename} в позиции с {$a->indfirst} по {$a->indlast} не поддерживается {$a->engine}.';
...
$string['wrong_close_paren_node_error']            = 'Syntax error: missing opening parenthesis \'(\' for the closing parenthesis in position {$a->indfirst}.';
$string['wrong_open_paren_node_error']             = 'Syntax error: missing a closing parenthesis \')\' for the opening parenthesis in position {$a->indfirst}.';
...
$string['set_and_unset_same_modifier_node_error']  = 'Setting and unsetting the {$a->addinfo} modifier at the same time in position from {$a->indfirst} to {$a->indlast}.';
...
$string['invalid_escape_sequence_node_error']      = 'Invalid escape sequence: {$a->addinfo}.';
...
$string['unknown_modifier_node_error']             = 'Unknown, wrong or unsupported modifier(s): {$a->addinfo}.';
...
$string['wrong_condsubexpr_number_node_error']     = 'Wrong subexpression number: digits expected.';
...
// TYPE_NODE_SUBEXPR
$string['description_subexpression'] = 'подмаска №%number: [%1]';
$string['description_subexpression_once'] = 'однократная подмаска №%number: [%1]';
$string['description_subexpression_name'] = 'подмаска "%name": [%1]';
$string['description_subexpression_once_name'] = 'однократная подмаска "%name": [%1]';
...
$string['description_node_cond_subexpr'] = 'если %cond, тогда проверить: [%1]%else';
$string['description_node_cond_subexpr_else'] = ' иначе проверить: [%2]';
$string['description_backref_node_cond_subexpr'] = 'если подмаска №%number была успешно сопоставлена, тогда проверить: [%1]%else';
$string['description_backref_node_cond_subexpr_name'] = 'если подмаска "%name" была успешно сопоставлена, тогда проверить: [%1]%else';
$string['description_recursive_node_cond_subexpr_all'] = 'если весь шаблон был рекурсивно сопоставлен тогда проверить: [%1]%else';
$string['description_recursive_node_cond_subexpr'] = 'если подмаска №%number была успешно рекурсивно сопоставлена, тогда проверить: [%1]%else';
$string['description_recursive_node_cond_subexpr_name'] = 'если подмаска "%name" была успешно рекурсивно сопоставлена, тогда проверить: [%1]%else';
$string['description_define_node_cond_subexpr'] = 'описание %1';
// TYPE_LEAF_CONTROL
