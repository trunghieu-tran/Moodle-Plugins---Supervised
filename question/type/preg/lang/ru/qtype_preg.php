...
$string['condsubexpr_too_much_alter_node_error']   = 'Синтаксическая ошибка: три или более альтернатив на верхнем уровне в условном подвыражении в позиции с {$-> colfirst} до {$-> collast}. Используйте скобки, если вы хотите включить больше альтернатив.';
...
$string['authoring_form_match_header_help'] = 'Здесь вы можете ввести некоторые строки (каждую строку с новой строки), чтобы проверить регулярное выражение. После нажатия кнопки "Проверить строку (строки)" результаты будут отображены справа: совпавшие части выделены зеленым цветом, не совпавшие части красным. Иконка показывает вам, со всем ли регулярным выражением совпала строка.';
...
$string['explain_time'] = ' раз';
$string['explain_times'] = ' раз';
$string['explain_any'] = 'любое кол-во';
