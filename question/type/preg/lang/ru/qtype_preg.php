...
$string['fa_recursion_limit'] = 'Предел рекурсии';
$string['fa_recursion_limit_description'] = 'Максимальный уровень рекурсии во время матчинга шаблонов, содержащих (?R), используя движок КА. Эта настройка регулирует использование времени и памяти и предотвращает от бесконечных циклов рекурсии.';
