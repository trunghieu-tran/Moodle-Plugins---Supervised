...
$string['syntax_tree_tool_help'] = 'Здесь вы можете видеть синтаксическое дерево. При нажатии на узел дерева выделится соответствующее поддерево, подграф и часть в словесном описании.';
...
$string['missing_open_paren_node_error']           = 'Синтаксическая ошибка: ожидалась открывающая круглая скобка \'(\' для закрывающей круглой скобки в позиции {$a->indfirst}.';
$string['missing_close_paren_node_error']          = 'Синтаксическая ошибка: ожидалась закрывающая круглая скобка \')\' для открывающей круглой скобки в позиции {$a->indfirst}.';
$string['missing_comment_ending_node_error']       = 'Синтаксическая ошибка: ожидалась закрывающая круглая скобка для комментария в позиции с {$a->indfirst} по {$a->indlast}.';
...
$string['unclosed_charset_node_error']             = 'Синтаксическая ошибка: ожидалась закрывающая квадратная скобка \']\' для символьного класса, начавшегося с позиции {$a->indfirst}.';
$string['posix_class_outside_charset_node_error']  = 'POSIX классы не допускаются за пределами символьного класса.';
$string['quantifier_without_parameter_node_error'] = 'Синтаксическая ошибка: квантификатор в позиции с {$a->indfirst} до {$a->indlast} не имеет операнда - нечего повторять.';
...
$string['condsubexpr_too_much_alter_node_error']   = 'Синтаксическая ошибка: три или более альтернатив на верхнем уровне в условном подвыражении в позиции с {$-> indfirst} до {$-> indlast}. Используйте скобки, если вы хотите включить больше альтернатив.';
$string['condsubexpr_assert_expected_node_error']  = 'Ожидался ассерт или условие.';
...
$string['authoring_form_page_header'] = 'Инструменты автора';
...
$string['authoring_form_update_text'] = 'Обновить';
$string['authoring_form_save_text'] = 'Сохранить';
$string['authoring_form_cancel_text'] = 'Отмена';
...
$string['authoring_form_match_header_help'] = 'Здесь вы можете ввести некоторые строки (каждую строку с новой строки), чтобы проверить регулярное выражение. После нажатия кнопки "Проверить строку (строки)" результаты будут отображены справа: совпавшие части выделены зеленым цветом, не совпавшие части красным.';
$string['authoring_form_match_textarea'] = 'Введите строки для проверки (каждую строку с новой строки)';
...
$string['description_control_backtrack'] = 'если остальные шаблоны не соответствует {$a->what}';
