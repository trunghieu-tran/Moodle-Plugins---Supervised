...
class qtype_preg_authoring_form extends moodleform {
    ...
    function definition() {
        ...
        $mform->addElement('html', '<link href="/question/type/poasquestion/shadow.css" id="SL_resources" rel="stylesheet" type="text/css">');
        $mform->addElement('html', '<link href="/question/type/poasquestion/rect.css" id="SL_rect" rel="stylesheet" type="text/css">');
