 ...
 * a {@link question_grading_advanced_strategy}.
 * An advanced strategy look for answer that best fit to given response even if response
 * doesn't match any answer. Such answer could be used to give hints.
 *
 * @copyright  2011 Sychev Oleg
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
/*abstract class question_graded_by_advanced_strategy extends question_graded_automatically {
}*/
 ...
 * {@link question_best_fit_answer_grading_strategy_with_known_correct_answer}.
 *
 * @copyright  2011 Sychev Oleg
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
/*interface question_response_fitness_calculator {
     ...
     * @return array('full' => is answer full, 'fitness' => number, showing how much this answer fit with response, the more fit - the better)
     */
   // public function compare_response_with_answer(array $response, question_answer $answer);
//}*/

/**
 * This grading strategy is used by question types like preg that uses hinting.
 * It gets a list of possible answers from the question, and returns the one
 * that best fit with given response. It returns the correct answer stored in question.
 *
 * @copyright  2011 Sychev Oleg
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
//class question_best_fit_answer_grading_strategy_with_known_correct_answer implements question_grading_strategy {
   /**
     * @var question_response_fitness_calculator (presumably also a
     * {@link question_definition}) the question we are doing the grading for.
     */
    //protected $question;

    /**
     * @param question_response_fitness_calculator $question (presumably also a
     * {@link question_definition}) the question we are doing the grading for.
     */
    /*public function __construct(question_response_fitness_calculator $question) {
        $this->question = $question;
    }*/
//TODO - probably shoudn't use question_grading_strategy and question_graded_by_strategy at all, since they don't expect unfull best fitness answer
/*
 * @return - not only answer, but is match full or not too!!!
 */
   /* public function grade(array $response) {
        $maxfitness = (-1)*(strlen($state->response['answer'])+1);
        $full = false;
